...
=================================
Background: THEOREM 19 from Introduction to Computer Theory by Daniel I. A. Cohen (pg. 215)
...
METHODOLOGY: Using Part 1 of Theorem 19 above, we can test a graph defining a language by testing all strings of all combinations of the alphabet for this language and see if any word we can create is accepted. By Part 1, if any word is accepted, then this language in INFINITE, else it is FINITE.



SOURCE CODE:
	Located: ../Program2_CameronEmbree/JavaSourceCode/InfiniteLanguageCheck/srs/
	Description: Coded in Java - coded in Eclipse
	

TM GRAPH DESCRIPTIONS:
	Located: ../Program2_CameronEmbree/JavaSourceCode/InfiniteLanguageCheck/
	Description: Formatting in text files: SOURCE_STATE-SOURCE_TYPE-DESTINATIONCOST-...-DESTINATIONCOST
...
TEST RUNS:
	Located: ../Program2_CameronEmbree/TestRuns.txt
	Description: Literally copy and pasted from running the source code in Eclipse. Contains description of the graph for the lagnuage from HW3Q4 (i), (ii), (iii) and (iv), followed by weather these languages are infinite or finite.
